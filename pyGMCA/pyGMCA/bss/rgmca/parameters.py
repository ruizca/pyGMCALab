...
data_setting["ampliO"] = 100.0  # standard deviation (amplitude)
...
algo_setting["kSMax"] = 3.0  # Final threshold for the sources with 3*mad
...
param_setting["param"] = np.array(
    [1, 5, 10, 15, 20, 25, 30, 35, 40]
)  # Values of the varying parameters
