...
data_setting["gS"] = 100.0  # Standard deviation of the Gaussian law

"""Gaussian Noise"""
data_setting["gN"] = 50.0  # SNR in dB

"""Outliers"""
data_setting["nbCol"] = 0.1 * data_setting["t"]  # Number of corrupted columns
data_setting["gO"] = -10.0  # Signal to Outliers ratio in dB
...
algo_setting["kSMax"] = 3.0  # Thresholding of the sources with kSMax-mad
algo_setting["kOMax"] = 3.0  # Thresholding of the outliers with kOMax-mad
